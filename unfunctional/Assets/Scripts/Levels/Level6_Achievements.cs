...
/// <summary>
/// LEVEL 6: Over-achiever level. Constant achievement popups for the most 
...
{
    [Header("Level 6 - Achievement Abuse")]
    ...
    public void UnlockRealAchievement(string achievementName)
    {
        ...
        Debug.Log($"[Level6] Real achievement unlocked: {achievementName} ({realAchievementsCollected}/{realAchievementsNeeded})");
    }

    private void ShowAchievementPopup(string text, bool isReal)
    {
        Debug.Log($"[Level6] {text}");
