...
Shader "Turishader/UI/VHSUIText"
{
    Properties
    {
        ...
        _Colorbleedingamount("Color bleeding amount", Range( 0 , 0.01)) = 0.01
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            uniform float _GlitchMinColorMultiply;
            uniform float _PixelGridSize;
            uniform float _PixelGridAmount;
            uniform float _ScanLinesFrenquency;
            uniform float _ScanLinesSpeed;
            uniform float _ScanLinesAmount;
            uniform float _GlitchMinOpacity;
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float temp_output_542_0 = ( _BlurAmount * 0.5 );
                float temp_output_543_0 = ( 0.5 - temp_output_542_0 );
                float temp_output_545_0 = ( 0.5 + temp_output_542_0 );
                ...
                float2 appendResult301 = (float2(( 0.0 * break529.x ) , ( break529.y * _GlitchTiling )));
                ...
                float GlitchAmount444 = _GlitchAmount;
                ...
                float smoothstepResult533 = smoothstep( temp_output_543_0 , temp_output_545_0 , tex2D( _MainTex, appendResult437 ).a);
                float2 appendResult493 = (float2(_Colorbleedingamount , 0.0));
                float smoothstepResult536 = smoothstep( temp_output_543_0 , temp_output_545_0 , tex2D( _MainTex, ( appendResult437 + appendResult493 ) ).a);
                float2 appendResult494 = (float2(( _Colorbleedingamount * -1.0 ) , 0.0));
                float smoothstepResult540 = smoothstep( temp_output_543_0 , temp_output_545_0 , tex2D( _MainTex, ( appendResult437 + appendResult494 ) ).a);
                float4 appendResult490 = (float4(( IN.color.r * smoothstepResult533 ) , ( IN.color.g * smoothstepResult536 ) , ( IN.color.b * smoothstepResult540 ) , 0.0));
                ...
                float simplePerlin2D549 = snoise( temp_output_469_0*300.0 );
                simplePerlin2D549 = simplePerlin2D549*0.5 + 0.5;
                float simplePerlin2D550 = snoise( temp_output_469_0*350.0 );
                simplePerlin2D550 = simplePerlin2D550*0.5 + 0.5;
                float simplePerlin2D548 = snoise( temp_output_469_0*250.0 );
                simplePerlin2D548 = simplePerlin2D548*0.5 + 0.5;
                float4 appendResult551 = (float4(simplePerlin2D549 , simplePerlin2D550 , simplePerlin2D548 , 0.0));
                float4 lerpResult476 = lerp( float4( 1,1,1,0 ) , appendResult551 , _NoiseAmount);
                float4 Noise525 = lerpResult476;
                float lerpResult320 = lerp( 1.0 , pow( simplePerlin2D304 , 3.0 ) , _GlitchAmount);
                float Glitch324 = lerpResult320;
                float2 temp_cast_0 = (_PixelGridSize).xx;
                float temp_output_2_0_g71 = 0.7;
                float2 appendResult10_g72 = (float2(temp_output_2_0_g71 , temp_output_2_0_g71));
                float2 temp_output_11_0_g72 = ( abs( (frac( (PatternUV463*temp_cast_0 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g72 );
                float2 break16_g72 = ( 1.0 - ( temp_output_11_0_g72 / max( fwidth( temp_output_11_0_g72 ) , float2( 1E-05,1E-05 ) ) ) );
                float lerpResult503 = lerp( 1.0 , saturate( min( break16_g72.x , break16_g72.y ) ) , _PixelGridAmount);
                float Grid505 = lerpResult503;
                float mulTime520 = _Time.y * _ScanLinesSpeed;
                float temp_output_519_0 = ( ( PatternUV463.y * _ScanLinesFrenquency ) + mulTime520 );
                float lerpResult511 = lerp( 1.0 , (0.0 + (sin( temp_output_519_0 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) , _ScanLinesAmount);
                float ScanLines512 = lerpResult511;
                float Alpha421 = ( IN.color.a * max( max( smoothstepResult533 , smoothstepResult536 ) , smoothstepResult540 ) * max( Glitch324 , _GlitchMinOpacity ) );
                float4 appendResult401 = (float4(( appendResult490 * _ColorMultiplier * Noise525 * max( Glitch324 , _GlitchMinColorMultiply ) * Grid505 * ScanLines512 ).xyz , Alpha421));
...
Node;AmplifyShaderEditor.RangedFloatNode;327;-1376,1664;Inherit;False;Property;_GlitchTiling;GlitchTiling;11;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;321;-176,1744;Inherit;False;Property;_GlitchAmount;GlitchAmount;10;1;[Header];Create;True;1;Glitch;0;0;False;0;False;0;0.388;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;442;-1600,-64;Inherit;False;Property;_DistortionAmount;DistortionAmount;14;0;Create;True;0;0;0;False;0;False;0;0.002;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;524;-2912,784;Inherit;False;1652;434.95;;13;508;513;507;521;514;520;519;510;511;512;518;546;547;Scanlines;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;435;-1104,-64;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;491;-1280,192;Inherit;False;Property;_Colorbleedingamount;Color bleeding amount;2;0;Create;True;0;0;0;False;0;False;0.01;0.00282;0;0.01;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;508;-2832,912;Inherit;False;463;PatternUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;527;-1234,846;Inherit;False;1465.959;370.95;;12;470;472;467;471;469;477;476;525;548;549;550;551;Noise;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;475;-1200,-320;Inherit;False;Property;_BlurAmount;BlurAmount;3;0;Create;True;0;0;0;False;0;False;0;0.337;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;521;-2864,1104;Inherit;False;Property;_ScanLinesSpeed;ScanLinesSpeed;8;0;Create;True;1;Glitch;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;507;-2832,992;Inherit;False;Property;_ScanLinesFrenquency;ScanLinesFrenquency;7;0;Create;True;1;Glitch;0;0;False;0;False;100;400;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;542;-928,-240;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;535;-528,-176;Inherit;True;Property;_TextureSample3;Texture Sample 2;15;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;532;-528,-416;Inherit;True;Property;_TextureSample2;Texture Sample 2;15;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleSubtractOpNode;543;-752,-288;Inherit;False;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;545;-736,-160;Inherit;False;2;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;519;-2240,928;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;469;-624,960;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;324;384,1520;Inherit;False;Glitch;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;536;-240,-144;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.6;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;539;-488.0685,48.30328;Inherit;True;Property;_TextureSample4;Texture Sample 2;15;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;500;-2880,1456;Inherit;False;463;PatternUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SmoothstepOpNode;533;-240,-320;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.6;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;504;-2880,1536;Inherit;False;Property;_PixelGridSize;PixelGridSize;5;0;Create;True;1;Glitch;0;0;False;0;False;100;100;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;546;-2032,1008;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;548;-480,1056;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;250;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;549;-480,864;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;300;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;550;-480,960;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;350;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;420;-384,272;Inherit;False;324;Glitch;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;540;-208,0;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.6;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;483;-64,-208;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;510;-2336,1072;Inherit;False;Property;_ScanLinesAmount;ScanLinesAmount;6;1;[Header];Create;True;1;Scanlines;0;0;False;0;False;0;0.543;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;501;-2608,1632;Inherit;False;Property;_PixelGridAmount;PixelGridAmount;4;1;[Header];Create;True;1;Grid;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;441;-512,400;Inherit;False;Property;_GlitchMinOpacity;GlitchMinOpacity;12;0;Create;True;1;Glitch;0;0;False;0;False;0;0.793;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;547;-1888,992;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;477;-496,1168;Inherit;False;Property;_NoiseAmount;NoiseAmount;9;1;[Header];Create;True;1;Noise;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;551;-272,912;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;440;-144,320;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;411;-464,-608;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;485;48,-96;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;476;-128,912;Inherit;False;3;0;FLOAT4;1,1,1,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;534;-32,-464;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;405;208,-128;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;537;16,-368;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;538;64,-272;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;496;0,336;Inherit;False;Property;_GlitchMinColorMultiply;GlitchMinColorMultiply;13;0;Create;True;1;Glitch;0;0;False;0;False;0;0.811;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;525;32,912;Inherit;False;Noise;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;495;384,32;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;526;688,-16;Inherit;False;525;Noise;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.DynamicAppendNode;490;208,-384;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;421;384,-128;Inherit;False;Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;409;688,-112;Inherit;False;Property;_ColorMultiplier;ColorMultiplier;1;1;[Header];Create;True;1;Color;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;506;688,48;Inherit;False;505;Grid;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;517;688,128;Inherit;False;512;ScanLines;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;408;912,-96;Inherit;False;6;6;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;448;912,128;Inherit;False;421;Alpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;401;1104,-64;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;518;-2048,848;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;397;1264,-64;Float;False;True;-1;3;AmplifyShaderEditor.MaterialInspector;0;3;Turishader/UI/VHSUIText;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;False;True;3;1;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;True;True;True;True;True;0;True;_ColorMask;False;False;False;False;False;False;False;True;True;0;True;_Stencil;255;True;_StencilReadMask;255;True;_StencilWriteMask;0;True;_StencilComp;0;True;_StencilOp;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;0;True;unity_GUIZTestMode;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;False;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;535;0;403;0
WireConnection;535;1;480;0
WireConnection;532;0;403;0
WireConnection;532;1;437;0
...
WireConnection;536;0;535;4
WireConnection;536;1;543;0
WireConnection;536;2;545;0
WireConnection;539;0;403;0
WireConnection;539;1;482;0
WireConnection;533;0;532;4
WireConnection;533;1;543;0
WireConnection;533;2;545;0
WireConnection;546;0;519;0
WireConnection;548;0;469;0
WireConnection;549;0;469;0
WireConnection;550;0;469;0
WireConnection;540;0;539;4
WireConnection;540;1;543;0
WireConnection;540;2;545;0
WireConnection;483;0;533;0
WireConnection;483;1;536;0
...
ASEEND*/
//CHKSM=B6BAAF79E22027ED1F27999DF5ADF7C7484D8CA4